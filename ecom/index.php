...
<div class="header_bg">
 ...
 <!--start-content-->
	...
	<div class="collection-section">
		 <div class="container"> 
		     <h3 class="tittle fea">COFFEES & TEAS</h3>
		   <div class="fashion-info">
				<div class="col-md-4 fashion-grids">
					<figure class="effect-bubba">
						<img src="images/f7.jpg" alt=""/>
						<figcaption>
							<h4>Ecomm Shop</h4>
							<p class="cart"><a href="coffees.php">Shop</a></p>				
						</figcaption>			
					</figure>		
				</div>
				<div class="col-md-4 fashion-grids">
