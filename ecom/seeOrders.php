	...
	<div class="header">
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			<li><a class="color6" href="seeOrders.php">ORDERS</a></li>			
				<li><a class="color8" href="feedbackshow.php">FEEDBACK</a></li>
			</li>
                <li>
		...
		<div class="container">
			...
			<div class="col-md-4 products-grid-right">
					...
					<div class="details-left-info simpleCart_shelfItem">
						...
						$result = mysqli_query($conn,"SELECT * FROM orders ORDER BY ord_id DESC");
						echo "<table>";
						while($row = mysqli_fetch_array($result))
								  {
								  echo "<tr><td>" . $row['ord_id'] . "<br>" . $row['p_id'] . "<br>" . $row['fullname']. "<br>" . $row['address']. "<br>" . $row['pincode']. "<br>" . $row['city']. "<br>" . $row['mobile']. "<br><br>";
								  }
						echo "</table>";
						mysqli_close($conn);
						?>
