...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#">Feedback</style></a> | Call us : +1 (812) 334-3997</span>
			</div>
...
<form action="checklogin1.php" method="post">
  ...
  <br>
  <fieldset>
    <label for="name"><h2>Username:</h2></label>
    <input type="text" id="name" name="user_name" >

    <label for="passw"><h2>Password:</h2></label>
