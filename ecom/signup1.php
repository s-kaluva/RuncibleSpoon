...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#.php">Feedback</style></a> | Call us : +1 (812) 334-3997</span>
			</div>
...
<form action="acct_created1.php" method="post">
  ...
  <fieldset>
    ...
    <input type="tel" pattern="[\+]\d{12}" id="mobile" name="user_mobile" require title="Format: +1XXXXXXXXXX" value="+1">    
