				...
				<div class="col-md-8 products-grid-left">
					...
					<?php					
						...
						if(isset($_GET['filter_price']))
						{
							...
							if($price == 0)
							$sql = " SELECT * FROM products WHERE p_type LIKE 'Lunch'";					
							if($price == 1)
							$sql = " SELECT * FROM products WHERE p_price < 5 AND p_type LIKE 'Lunch'";
							if($price == 2)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 5 AND 10 AND p_type LIKE 'Lunch'";
							if($price == 3)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 10 AND 20 AND p_type LIKE 'Lunch'";
							if($price == 4)
							$sql = " SELECT * FROM products WHERE p_price > 20 AND p_type LIKE 'Lunch'";
