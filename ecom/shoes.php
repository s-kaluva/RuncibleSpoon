			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 0)
						$sql = " SELECT * FROM products WHERE p_type LIKE 'Breakfast'";					
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 5 AND p_type LIKE 'Breakfast'";
						if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 5 AND 10 AND p_type LIKE 'Breakfast'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 10 AND 20 AND p_type LIKE 'Breakfast'";
						if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 20 AND p_type LIKE 'Breakfast'";				
						if (!$conn) {
