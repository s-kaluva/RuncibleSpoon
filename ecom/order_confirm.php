...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="feedback.php">Feedback</style></a> | +1 (812) 334-3997</span>
			</div>
...
<?php
	...
	if (isset($_POST['fullname']) && isset($_POST['address']) && isset($_POST['pincode']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['mobile']))
	{
		$name = $_POST['fullname'];
		...
		$mob = $_POST['mobile'];
							...
							$sql = " SELECT c_p_id FROM cart";
								...
								{
									$pid=$row["c_p_id"];
									$sql1 = " INSERT INTO orders (p_id,fullname,address,pincode,city,state,mobile) values  ('$pid','$name','$add','$pin','$citi','$stat','$mob') ";
		...
		$sql = " DELETE from cart ";
				...
				echo '<br><h1><center>Go Back To -> <a href="shoes.php">Breakfast</a> / <a href="tshirt.php">Lunch</a> / <a href="watches.php">Dinner</a>  /  <a href="cart.php">Go To Cart</a></center></h1>';
	}
?>
<!--//storing complete-->
 </div>
