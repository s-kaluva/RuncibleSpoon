	...
	<div class="header">
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			<li><a class="color6" href="shoes.php">Breakfast</a></li>			
				<li><a class="color8" href="tshirt.php">Lunch</a></li>
				<li><a class="color9" href="watches.php">Dinner</a></li>
				<li><a class="color9" href="coffees.php">Coffees & Teas</a></li>
			</li>	
		 </ul>
	</div>
</div>
...
<!-- products -->
				...
				<div class="col-md-5 grid-single">		
						<div class="flexslider">
							  <ul class="slides">							  
								...
								$sql = " SELECT * FROM products,cart cr WHERE p_id = cr.c_id";
								if (!$conn) {
								...
								<div class="col-md-3 single-text">
									...
									<h4>Zip Code</h4> <input type="text" size="5" name="pincode" pattern="\d{5}" title="5 digit postal code" required>
									<h4>City</h4> <input type="text" size="15" name="city" pattern="[a-zA-Z]+" title="Only alphabets allowed" placeholder="Bloomington">
									<h4>State</h4> <input type="text" size="30" name="state" pattern="[a-zA-Z]+" placeholder="Indiana">
									<h4>Mobile No.</h4> <input type="tel" name="mobile" pattern="[\+]\d{10}" require title="Format: XXXXXXXXXX" required>
									<br><br>
									<h2>Payment Method:</h2> <br>
									<input type="radio" checked> Cash on Delivery (COD)<br>
									<input type="radio" disabled> Card Payment (Credit/Debit)
									<br><br>';
	...
	<div class="col-md-4 products-grid-right" style="float: right; margin-right: 5%">
					<div class="w_sidebar">
						<div class="w_nav1">
							<h4><a><u>Your Items:</u></a></h4>
							<ul>
								<li>
								<?php 
								include 'connection.php';
								...
								while($row = mysqli_fetch_assoc($result)) {
								echo '								
								<h1>'.$row['c_name'].'</h1><br><h2><a href="#">Price:</a></h2><h2><span>$ '.$row['c_price'].' </span></h1><br/>-----';
								}
								}
								?></li>
								<li></li>
