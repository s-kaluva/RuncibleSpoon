...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="http://localhost/infoweb/rspoon/index.html"><img id="logo" src="images/logo.png"><h1>RUNCIBLE <span>SPOON</span></h1></a>
		  </div>
		...
		<!-- <ul class="megamenu skyblue">
			<li><a class="color1" href="index.php">Home</a></li>
				...
				<li><a class="color9" href="coffee.php">COFFEES & TEAS</a></li>
                <li>
							  ...
							  <ul class="slides">							  
								...
								if (mysqli_num_rows($result) > 0) 
								{
									...
									<div class="details-left-info simpleCart_shelfItem">
										<p class="availability">Availability: <span class="color">Time dependent!</span></p>
										<div class="price_single">
											<span class="actual item_price">'.$row['p_name'].'<br/>    $ '.$row['p_price'].'</span>
										</div>
										<h2 class="quick">What is it?</h2>
										<p class="quick_desc">'.$row['p_desc'].'</p>
