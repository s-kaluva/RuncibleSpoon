...
<!--order strored in database-->
	<div class="products">
		...
		$sql = "SELECT * FROM products WHERE p_id = $mycart";
			...
			echo '<span style="color:#DB4437;text-align:center;"><h1><center> Item added to your cart successfully </center></h1></span>'; 
			echo '<br><h1><center>Go Back To -> <a href="shoes.php">Breakfast</a> / <a href="tshirt.php">Lunch</a> / <a href="watches.php">Dinner</a>/ <a href="coffees.php">Coffees & Teas</a>  /  <a href="cart.php">Go To Cart</a></center></h1>';
			?>
		<!--storing complete-->
</div>
